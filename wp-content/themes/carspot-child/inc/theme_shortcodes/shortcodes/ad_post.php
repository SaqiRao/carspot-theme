    ...
    window.onload = function () {
        ...
        map.fitBounds(latlngbounds);*/
            ...
            /*==== Appointment Features ====*/
              $model  =  get_post_meta(get_the_ID(), '_carspot_tpl_field_ad_model', true);
              $model  = isset($model) ? $model : "";
             //Brands
             $brand   =  get_post_meta(get_the_ID(), '_carspot_tpl_field_ad_brand', true);
             $brand   = isset($brand) ? $brand : "";
            //Number Of Hours
             $hour     = get_post_meta(get_the_ID(), '_carspot_tpl_field_ad_hours', true);
             $hour     = isset($hour) ? $hour : "";
            //weight
             $weight   = get_post_meta(get_the_ID(), '_carspot_tpl_field_ad_weight', true);
        ...
        $ad_years_db = get_post_meta(get_the_ID(), '_carspot_ad_years', true);
...
<?php
    ...
    <div class="container">
	 ...
	 <!-- end post-padding -->
	 <div class="post-ad-form postdetails   sssssss  fffff">
		<form  class="submit-form" id="ad_post_form">
		   ...
		   <div class="row" id="ad_cat_sub_sub_sub_div">
            ...
            <div class="row">
            <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                <label class="control-label">' . esc_html__('Brands', 'carspot') . '</label>
                 <input class="form-control" name="ad_brand" data-parsley-required="true" data-parsley-error-message="' . esc_html__('This field is required.', 'carspot') . '" value="' . $brand . '" type="text">
           </div>
        
            <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
               <label class="control-label">' . esc_html__('Model', 'carspot') . '</label>
               <input class="form-control" name="ad_model" data-parsley-required="true" data-parsley-error-message="' . esc_html__('This field is required.', 'carspot') . '" value="' . $model . '" type="text">
            </div>
            </div>
            ...
            <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                <label class="control-label">' . esc_html__('Tonnage', 'carspot') . '</label>
                <input class="form-control" name="ad_weight" data-parsley-required="true" data-parsley-error-message="' . esc_html__('This field is required.', 'carspot') . '" value="' . $weight . '" type="text">
            </div>

            </div>
            <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                <label class="control-label">' . esc_html__('Number of hours', 'carspot') . '</label>
                <input class="form-control" name="ad_hour" data-parsley-required="true" data-parsley-error-message="' . esc_html__('This field is required.', 'carspot') . '" value="' . $hour . '" type="text">
            </div>
            </div>
            <div class="row">
