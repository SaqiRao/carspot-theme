...
$query_ = carspot_wpml_show_all_posts_callback($query_);
$the_query = new WP_Query($query_);
                            ...
                            <td>
                            	<span class="ad-actions">
                                    ...
                                    if (isset($carspot_theme['sb_demo_mode']) && $carspot_theme['sb_demo_mode'] == true) {
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="javascript:void(0);"> <i
                                                                        class="la la-exclamation-triangle"></i> <?php echo esc_attr__('Active Ad', 'carspot') ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:void(0);"> <i
                                        ...
                                        <li>
                                             <?php
                                             $cs_post_sold_page = cs_language_page_id_callback($carspot_theme['sb_post_ad_page']);
                                             $cs_post_sold_page_ = carspot_set_url_params_multi(get_the_permalink($cs_post_sold_page), array("id" => esc_attr($pid)));
                                             ?>
                                            <a href="<?php echo $cs_post_sold_page_; ?>"
                                               class="protip"
