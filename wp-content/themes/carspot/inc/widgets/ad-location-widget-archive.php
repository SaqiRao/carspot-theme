...
add_action('widgets_init', function () {
    register_widget('carspot_archive_ad_location');
});
if (!class_exists('carspot_archive_ad_location')) {

    class carspot_archive_ad_location extends WP_Widget
    {
        ...
        {
            $widget_ops = array(
                'classname' => 'carspot_archive_ad_location',
                'description' => esc_html__('Only for country  ad sidebar.', 'carspot'),
            );
            // Instantiate the parent object
            parent::__construct(false, esc_html__('Carspot:Ad Location Archive', 'carspot'), $widget_ops);
        }
