...
if (!function_exists('carspotAPI_homeScreen_get')) {
    ...
    function carspotAPI_homeScreen_get()
    {
        ...
        $data['have_user_package'] = true;
        if (get_user_meta($user_id, '_sb_simple_ads', true) == 0 || get_user_meta($user_id, '_sb_simple_ads', true) == "") {
            $data['have_user_package'] = false;
        }
        /** check if user loggedin */
        $data['have_loggin_user'] = ($user_id != '') ? true : false;
        ...
        $carspot_api_body_sec_views = '3';
        $carspot_api_list_sec_views = '1';
        $carspot_api_body_make_views = '1';
        $home_thme_header_title = __('Automotive Car Dealer', 'carspot-rest-api');
        $home_thme_header_sub_title = __('More than 17,000 business listed', 'carspot-rest-api');
        $total_no_cars_your_area = __('17,288', 'carspot-rest-api');
        $total_no_cars_your_area_text = __('Used cars for sale in you Town search now', 'carspot-rest-api');
        $home_theme_baner_img = CARSPOT_API_PLUGIN_URL . "images/theme-baner.png";
        /*
         * Theme Screens Start
         */
        //theme header title
        if (isset($carspotAPI['home_thme_header_title']) && $carspotAPI['home_thme_header_title'] != "") {
            $home_thme_header_title = $carspotAPI['home_thme_header_title'];
        }
        // theme header subtitle
        if (isset($carspotAPI['home_thme_header_sub_title']) && $carspotAPI['home_thme_header_sub_title'] != "") {
            $home_thme_header_sub_title = $carspotAPI['home_thme_header_sub_title'];
        }
        //theme your cars in your area
        if (isset($carspotAPI['total_no_cars_your_area']) && $carspotAPI['total_no_cars_your_area'] != "") {
            $total_no_cars_your_area = $carspotAPI['total_no_cars_your_area'];
        }
        //cars in your area text
        if (isset($carspotAPI['total_no_cars_your_area_text']) && $carspotAPI['total_no_cars_your_area_text'] != "") {
            $total_no_cars_your_area_text = $carspotAPI['total_no_cars_your_area_text'];
        }
        //theme banner image
        if (isset($carspotAPI['home_theme_baner_img']) && $carspotAPI['home_theme_baner_img']['url'] != "") {
            $home_theme_baner_img = $carspotAPI['home_theme_baner_img']['url'];
        }
        /* body section style */
        if (isset($carspotAPI['carspot_api_body_sec_views']) && $carspotAPI['carspot_api_body_sec_views'] != "") {
            $carspot_api_body_sec_views = $carspotAPI['carspot_api_body_sec_views'];
        }
        /* listing section style */
        if (isset($carspotAPI['carspot_api_list_sec_views']) && $carspotAPI['carspot_api_list_sec_views'] != "") {
            $carspot_api_list_sec_views = $carspotAPI['carspot_api_list_sec_views'];
        }
        /* body make section style */
        if (isset($carspotAPI['carspot_api_body_make_views']) && $carspotAPI['carspot_api_body_make_views'] != "") {
            $carspot_api_body_make_views = $carspotAPI['carspot_api_body_make_views'];
        }
        $data['api_body_sec_views'] = $carspot_api_body_sec_views;
        $data['api_list_sec_views'] = $carspot_api_list_sec_views;
        $data['api_body_make_views'] = $carspot_api_body_make_views;
        $data['home_thme_header_title'] = $home_thme_header_title;
        $data['home_thme_header_sub_title'] = $home_thme_header_sub_title;
        $data['total_no_cars_your_area'] = $total_no_cars_your_area;
        $data['total_no_cars_your_area_text'] = $total_no_cars_your_area_text;
        $data['home_theme_baner_img'] = $home_theme_baner_img;
        /*
         * Theme Screens End
         */
        $has_value = false;
            ...
            if (isset($array_sortable) && $array_sortable > 0) {
                ...
                foreach ($arrays as $key => $val) {
                    ...
                    if ($key == "cat_icons" && $val != "") {
                        ...
                        $data['featured_cat_count_txt'] = __('Ads', 'carspot-rest-api');
        ...
        /* Advertisement label */
        $sb_advertise_ad_label = '';
        if (isset($carspotAPI['sb_advertise_ad_label']) && $carspotAPI['sb_advertise_ad_label'] != "") {
            $sb_advertise_ad_label = $carspotAPI['sb_advertise_ad_label'];
        }
        $data['extra']['sb_advertise_ad_label'] = $sb_advertise_ad_label;
            ...
            if (isset($carspotAPI['carspot-api-ad-cats-multi'])) {
                ...
                if (count($cats) > 0) {
                    foreach ($cats as $cat) {
                        ...
                        $catData[] = array("cat_id" => $term->term_id, "name" => $name, "img" => $imgUrl, "cat_count" => $term->count);
                    }
                }
            }
            return $catData;
...
if (!function_exists('carspotAPI_homeScreen_post')) {
    ...
    function carspotAPI_homeScreen_post($request)
    {
        ...
        $data['firebase_reg_ios'] = get_user_meta($user_id, '_sb_user_firebase_id_ios', true);
        $data['firebase_reg_android'] = get_user_meta($user_id, '_sb_user_firebase_id', true);
