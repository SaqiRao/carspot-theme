            ...
            if (isset($carspotAPI['api_woo_products_multi'])) {
                ...
                if (count($productsData) > 0) {
                    foreach ($productsData as $product) {
                        ...
                        $product = cs_language_page_id_callback($product,'product');
                        ...
                        if ($is_exists) {
                            ...
                            $pdata['free_ads_text'] = __('Regular Listings', 'carspot-rest-api');
                            ...
                            $pdata['product_desc'] = $productData->get_description();
...
if (!function_exists('carspotAPI_andrid_product_key_func')) {
    ...
    function carspotAPI_andrid_product_key_func($post)
    {
        ...
        <div>
            ...
            <input type="text" name="package_product_code_android" class="project_meta"
                   placeholder="<?php echo esc_attr__('Enter you android product code here.', 'carspot-rest-api'); ?>"
                   size="30"
                   value="<?php echo esc_attr(get_post_meta($post->ID, "package_product_code_android", true)); ?>"
                   id="package_product_code_android" spellcheck="true" autocomplete="off">
        ...
        <div>
            ...
            <input type="text" name="package_product_code_ios" class="project_meta"
                   placeholder="<?php echo esc_attr__('Enter you ios product code here.', 'carspot-rest-api'); ?>"
                   size="30" value="<?php echo esc_attr(get_post_meta($post->ID, "package_product_code_ios", true)); ?>"
                   id="package_product_code_ios" spellcheck="true" autocomplete="off">
        ...
        <p>
            <strong>*<?php echo __("Please make sure you have created the **** product while create packages in AppStore/PlayStore accounts.", 'carspot-rest-api'); ?></strong>
        </p>
        <?php
    }
