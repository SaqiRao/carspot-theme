...
class Services_Two extends Widget_Base {

    public function get_name() {
        return 'services_short_base_2';
    }

    public function get_title() {
        return __('Services Style 2', 'cs-elementor');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
                'services_short_base_2_basic_tab',
                [
    ...
    protected function render() {
        ...
        echo cs_elementor_services_two($params);
    }
