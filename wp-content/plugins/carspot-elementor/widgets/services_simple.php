...
class Services_Simple extends Widget_Base {

    public function get_name() {
        return 'services_short_base_simple';
    }

    public function get_title() {
        return __('Services Simple', 'cs-elementor');
    }
    ...
    protected function render() {
        ...
        echo cs_elementor_services_simple($params);
    }
