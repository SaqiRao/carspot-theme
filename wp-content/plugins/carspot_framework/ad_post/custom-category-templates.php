        ...
        <tr class="user-rich-editing-wrap">
            ...
            <td class="username column-username has-row-actions column-primary">
                <label for="<?php echo($templatePriceRequired); ?>">
                    ...
                    <select name="<?php echo($templatePriceRequired); ?>"
                            id="<?php echo($templatePriceRequired); ?>">
        ...
        <tr class="user-rich-editing-wrap">
            ...
            <td class="username column-username has-row-actions column-primary">
                <label for="<?php echo($templatePriceTypeShow); ?>">
                    ...
                    <select name="<?php echo($templatePriceTypeShow); ?>"
                            id="<?php echo($templatePriceTypeShow); ?>">
        ...
        <tr class="user-rich-editing-wrap">
            ...
            <td class="username column-username has-row-actions column-primary">
                <label for="<?php echo($templateVideoRequired); ?>">
                    ...
                    <select name="<?php echo($templateVideoRequired); ?>"
                            id="<?php echo($templateVideoRequired); ?>">
        ...
        <tr class="user-rich-editing-wrap">
            ...
            <td class="username column-username has-row-actions column-primary">
                <label for="<?php echo($templateImageRequired); ?>">
                    ...
                    <select name="<?php echo($templateImageRequired); ?>"
                            id="<?php echo($templateImageRequired); ?>">
                        ...
                        <tr>
                            <td colspan="4">
                                <input id="add-custom-field-button" class="button button-primary add_field_button"
                                       value="<?php echo __('Add More Fields', 'redux-framework'); ?>" type="button">
                            </td>
                        </tr>
                        </tfoot>
                    </table>
        ...
        if (count((array)$taxs) > 0) {
            foreach ($taxs as $tax) {
                ...
                if (function_exists('carspot_string_translate')) {
                    $titles = carspot_string_translate($slug, $titles);
                }
                ...
                if ($slug == 'ad_mileage') {
                    $pow_dis_unit = $carspot_theme['sb_distance_unit'];
                }
                if ($slug == 'ad_engine_capacities') {
                    $pow_dis_unit = $carspot_theme['sb_power_unit'];
                }

                if ($values != "") {
                    $is_go = carspot_show_keyfeatures_excluding($slug);
                    if ($is_go) {
                        $html .= '<div class="col-sm-4 main col-md-4 col-xs-12 no-padding carspot-terms ' . esc_attr($slug) . '"><div class="terms-details"><span><strong>' . esc_html__($titles, "carspot") . '</strong> :</span> ' . esc_html($values) . " " . esc_html($pow_dis_unit) . '</div></div>';
                    }
                }
            }
        }
            ...
            if (count((array)$formData) > 0) {
                foreach ($formData as $data) {
                    ...
                    if ($value != "") {
						...
						<span><strong>' . esc_html__($titles, "carspot") . '</strong> :</span>
						' . ($value) . '
						</div>';
                    }
                }
...
function sb_text_field_data($term_id)
{
    ...
    foreach ($taxonomy_objects as $taxonomy_object) {
        ...
        if ('yst_prominent_words' == $taxonomy_object->name) {
            continue;
        }

        $arType[$taxonomy_object->name] = array('name' => $taxonomy_object->label,
...
{
    $terms = get_terms(array('taxonomy' => 'sb_dynamic_form_templates',
        'hide_empty' => false,
        'parent' => 0,
    ));
    $optionsHtml = '';
...
function carspot_post_ad_fields()
{
    ...
    if (isset($carspot_theme['carspot_package_type']) && $carspot_theme['carspot_package_type'] == 'category_based') {
        /* call this function if category base in theme  */
    ...
    if ($get_val['carspot_package_type'] != "" && $get_val['carspot_package_type'] == 'category_based') {
        ...
        function sb_render_meta_product_adons($post = '')
        {
            ...
            <div class="margin_top">
                ...
                <select name="category_and_adons" style="width:100%; height:40px;"
                        onChange="return carspot_catPricing_changeType();">

                    <option value=""><?php echo esc_html__('Select Option', 'redux-framework'); ?></option>
                    <option value="category_based" <?php if (get_post_meta($post->ID, "carspot_package_type", true) == 'category_based') {
                        echo 'selected';
                    } ?>>
                        <?php echo esc_html__('Categories Based Template', 'redux-framework'); ?>
                    </option>
                    <option value="adons_based" <?php if (get_post_meta($post->ID, "carspot_package_type", true) == 'adons_based') {
                        echo 'selected';
                    } ?>>
            ...
            <div class="margin_top post-ads-adons2" <?php if (get_post_meta($post->ID, "carspot_package_type", true) == 'category_based') {
                ...
                <select name="category_adons_ad_type" style="width:100%; height:40px;" required>
                    ...
                    <option value="featured" <?php if (get_post_meta($post->ID, "carspot_package_ad_type", true) == 'featured') {
                        echo 'selected';
                    } ?>>
                        <?php echo esc_html__('Featured Ad', 'redux-framework'); ?>
                    </option>
                    <option value="bump" <?php if (get_post_meta($post->ID, "carspot_package_ad_type", true) == 'bump') {
                        echo 'selected';
                    } ?>>
            ...
            <div class="post-ads-adons" <?php if (get_post_meta($post->ID, "carspot_package_type", true) == 'adons_based') {
                echo 'style="display:none;"';
            } ?>>
        ...
        function carspot_render_meta_product_adons($post = '')
        {
            ...
            <div class="margin_top">
                ...
                <input type="text" name="package_expiry_days" class="project_meta"
                       ...
                       size="30"
                       value="<?php echo esc_attr(get_post_meta($post->ID, "package_expiry_days", true)); ?>"
            ...
            <div>
                ...
                <input type="text" name="package_free_ads" class="project_meta"
                       ...
                       id="package_free_ads" spellcheck="true" autocomplete="off">
            </div>
            <div>
                ...
                <input type="text" name="package_featured_ads" class="project_meta"
                       ...
                       id="package_featured_ads" spellcheck="true" autocomplete="off">
            </div>
            <div>
                ...
                <input type="text" name="package_bump_ads" class="project_meta"
                       ...
                       id="package_bump_ads" spellcheck="true" autocomplete="off">
            </div>
        ...
        function carspot_themes_meta_save_product_adons($post_id)
        {
            ...
            {
                if($_POST['product-type'] == 'carspot_badge')
                {

                    update_post_meta($post_id,'badge_package',$_POST['product-type']);
                }
            }
        }
